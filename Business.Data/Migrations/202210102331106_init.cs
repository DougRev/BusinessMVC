    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Franchisee", t => t.FranchiseeId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Business", "FranchiseeId", "dbo.Franchisee");
            ...
            DropIndex("dbo.Business", new[] { "FranchiseeId" });
